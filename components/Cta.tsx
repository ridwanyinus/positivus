...
const Cta = () => {
  return (
    <main className="padding-x  pt-28 ">
      <section className="rounded-3xl  md:rounded-[2.813rem] bg-gray grid lg:grid-cols-2 place-items-center relative max-xs:p-6 py-10 xl:py-16">
        ...
        <div className="max-lg:mt-12 ml-8 xs:ml-12 small:ml-20 lg:ml-0 lg:absolute right-0 xl:-right-6 desktop:right-0 2xl:right-10 fourk:right-12 small:w-80 md:w-[25rem] lg:w-[23.438rem] xl:w-auto">
