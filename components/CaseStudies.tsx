...
const CaseStudies = () => {
  ...
  return (
    <main data-aos="fade-up" data-aos-delay="0" data-aos-offset="150" data-aos-easing="ease-in-sine" data-aos-duration="350" id="case" className="padding-x pt-8 md:pt-16 lg:pt-28 desktop:pt-36">
